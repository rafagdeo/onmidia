...
const Audiovisual = () => {
  return (
    <>
        <section className="relative md:h-screen mx-auto items-center content-center">
          {/* Vídeo de fundo */}
          <div className="md:absolute top-0 left-0 w-full h-[400px] -z-10">
              <iframe
                className="w-full h-full"
                src="https://www.youtube.com/embed/zAm-efzMVCg?autoplay=1&mute=1&loop=1&playlist=zAm-efzMVCg&controls=0&modestbranding=1&showinfo=0&fs=0&disablekb=1&rel=0"
                title="YouTube Video"
                frameBorder="0"
                allow="autoplay; encrypted-media"
                allowFullScreen></iframe>
          </div>
          <div className="bg-black md:bg-transparent pt-12 container md:w-[1280px] mx-auto space-y-12 px-4">
            <h1 className="font-bold text-3xl/tight md:text-5xl text-white">
        ...
        <section className="container mx-auto md:w-[1280px] p-4 flex flex-col gap-4 md:flex-row justify-between text-white">
          <h2 className="md:text-6xl text-5xl">
            Como fazemos?
          </h2>
          <a
            href="#form"
            className="inline-block items-center content-center bg-primary px-8 py-4 border-none font-medium text-white"
          >
            QUERO CONVERSAR COM A ON
          </a>
        </section>
        <section className="container mx-auto md:w-[1280px] p-4 text-white flex flex-col gap-4 py-12">
          <h3 className="text-2xl">1. Reunião e Diagnóstico</h3>
        ...
        <section className="bg-[#1E1E1E] p-4 text-white ">
          <div className="container mx-auto md:w-[1280px] flex flex-col gap-4 py-12">
        ...
        <section className="bg-[#262626] p-4 text-white">
          <div className="container mx-auto md:w-[1280px] flex flex-col gap-4 py-12">
            <h3 className="text-2xl">3. Produção</h3>
            <p className="font-medium">
        ...
        <section className="bg-[#333333] p-4 text-white ">
          <div className="container mx-auto md:w-[1280px] flex flex-col gap-4 py-12">
            <h3 className="text-2xl">4. Acompanhamento</h3>
            <p className="font-medium">
      ...
      <section style={{ backgroundImage: `url(${BG})` }}>
        <h2 className="text-white font-bold uppercase text-3xl md:text-4xl text-center py-32 p-4">
          Transformamos suas ideias em vídeos
          <br /> impactantes, criando conteúdo <br />
          audiovisual que conecta, emociona e<br /> entrega resultados.
        </h2>
      </section>
        ...
        <div className="container md:w-[1280px] mx-auto p-4 md:flex text-white justify-between space-y-4">
          ...
          <div className="formulario">
            <form onSubmit={onSubmit} className="flex flex-col gap-4">
              ...
              <button
                type="submit"
                className="bg-primary text-md py-4 px-8 text-white font-light hover:bg-purple-600"
              >
